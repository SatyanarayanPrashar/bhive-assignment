...
export const SpaceDetailModel: React.FC = () => {
    ...
    return (
        <div className="bg-white p-5 rounded-lg shadow-lg h-[80%] w-[70%] z-[99] overflow-y-auto">
            <div className='w-full flex items-ends justify-end font-bold mt-[-10px] mb-5' role='button'
                onClick={() => { dispatch(pageOpened(!pageState)); }}
            > X </div>
            <div className={cn('flex', isMobile && "flex-col-reverse")}>
